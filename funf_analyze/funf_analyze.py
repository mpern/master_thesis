...
# 
import data_processing.dbdecrypt as dbdecrypt
import data_processing.decrypt as decrypt
import data_processing.dbmerge as dbmerge
import viz_gen
import zipfile
...
def decrypt_all(files, key=None, password=None):
    # password = decrypt.prompt_for_password()
    if(password):
